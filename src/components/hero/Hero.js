...
export default function Hero() {
  ...
  useEffect(() => {
    //reset width on resize to load correct image
    ...
    <div className="hero monthly-packages-hero">
      <div className="image" style={{ backgroundImage: width > 1150 ? `url(${large})` : `url(${small})` }}>
        <div className="hero-text content-container">
          ...
          <h5 className="text">What's the best way to shop for the latest video games and peripherals? How about never shopping at all? 
          <br />You'll get new stuff on your doorstep &mdash; every month.</h5>
